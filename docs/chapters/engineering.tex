...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/diagrams/system_architecture.png}
  \caption{A DermAI rendszer magas szintű architektúrája: a két kliens (Android,
    web), a hozzájuk tartozó backendek (Flask, FastAPI), a modellt kiszolgáló
    MCP-réteg és a GPU-n futó ViT, valamint a Firebase és a Gemini szolgáltatások
    kapcsolatai.}
