...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/diagrams/abcde_rule.png}
  \caption{Az ABCDE-szabály vizuális kritériumai: a jóindulatú (felső sor) és
    rosszindulatú (alsó sor) pigmentált elváltozások sematikus összehasonlítása az
    aszimmetria, a határvonal, a szín, az átmérő és az evolúció szempontjából.
    Sematikus, illusztratív ábra -- nem valós klinikai felvétel.}
  \label{fig:abcde}
\end{figure}
